...
import 'package:amaga/features/exit/pages/customer_cylinder_page_exit.dart';
...
class ExitMainPage extends StatefulWidget {
  const ExitMainPage({super.key});
  final String token = "register";

  @override
  State<ExitMainPage> createState() => _RegisterPageState();
}

class _RegisterPageState extends State<ExitMainPage> {
                ...
                itemBuilder: (context, index) => CustomerCard(
                    ...
                    onClicked: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CustomerCylinderPageExit(
                            name: customers[index].name,
                            email: customers[index].email,
